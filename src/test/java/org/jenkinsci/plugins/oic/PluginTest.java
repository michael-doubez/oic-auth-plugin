...
public class PluginTest {
    ...
    public void testRefreshToken_validAndExtendedToken() throws Exception {
        ...
        mockTokenReturnsIdTokenWithGroup("ReFrEsH_ToKeN");
        mockUserInfoWithTestGroups();
        browseLoginPage();
        var user = assertTestUser();
        assertFalse(
    ...
    public void testRefreshTokenAndTokenExpiration_withoutRefreshToken() throws Exception {
        ...
        jenkins.setSecurityRealm(new TestRealm(wireMockRule, null, EMAIL_FIELD, GROUPS_FIELD, AUTO_CONFIG_FIELD));
        // login
        mockTokenReturnsIdTokenWithGroup(null);
        mockUserInfoWithTestGroups();
        browseLoginPage();
        assertTestUser();
    ...
    private void mockTokenReturnsIdTokenWithGroup() throws Exception {
        mockTokenReturnsIdTokenWithValues(setUpKeyValuesWithGroup(), null);
    }

    private void mockTokenReturnsIdTokenWithGroup(@CheckForNull String refreshToken) throws Exception {
        mockTokenReturnsIdTokenWithValues(setUpKeyValuesWithGroup(), refreshToken);
    }
    ...
    private void mockTokenReturnsIdTokenWithoutValues(KeyPair keyPair) throws Exception {
        mockTokenReturnsIdTokenWithValues(Map.of(), keyPair, null);
    }

    private void mockTokenReturnsIdTokenWithValues(Map<String, Object> keyValues) throws Exception {
        mockTokenReturnsIdTokenWithValues(keyValues, createKeyPair(), null);
    }

    private void mockTokenReturnsIdTokenWithValues(Map<String, Object> keyValues, @CheckForNull String refreshToken)
            throws Exception {
        mockTokenReturnsIdTokenWithValues(keyValues, createKeyPair(), refreshToken);
    }

    private void mockTokenReturnsIdTokenWithValues(
            Map<String, Object> keyValues, KeyPair keyPair, @CheckForNull String refreshToken) throws Exception {
        mockTokenReturnsIdToken(createIdToken(keyPair.getPrivate(), keyValues), refreshToken);
    }

    private void mockTokenReturnsIdToken(@CheckForNull String idToken, @CheckForNull String refreshToken) {
    ...
    private void mockTokenReturnsIdToken(@CheckForNull String idToken) {
        mockTokenReturnsIdToken(idToken, null);
    }
